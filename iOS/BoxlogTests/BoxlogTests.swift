import XCTest
@testable import Boxlog

@MainActor
final class BoxlogTests: XCTestCase {
    ...
    func testAddEntry() {
        ...
        store.add(combo: "1-2", value1: 10, value2: 5)
    ...
    func testAddRespectsFreeLimit() {
        ...
        for i in 0..<Store.freeLimit {
            store.add(combo: "1-2", value1: i, value2: 1)
        }
        let result = store.add(combo: "1-2", value1: 1, value2: 1)
    ...
    func testDeleteEntry() {
        let store = Store()
        store.entries = []
        store.add(combo: "1-2", value1: 1, value2: 1)
    ...
    func testDeleteAtOffsets() {
        ...
        store.entries = []
        store.add(combo: "1-2", value1: 1, value2: 1)
        store.add(combo: "1-2", value1: 2, value2: 2)
